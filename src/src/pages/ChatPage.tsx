...
import KavachSOSButton from '../components/chat/KavachSOSButton';
import SakhiCompanionCard from '../components/chat/SakhiCompanionCard';
import POCSOBanner from '../components/chat/POCSOBanner';
import './ChatPage.css';
...
export default function ChatPage() {
  ...
  const [showSakhi, setShowSakhi] = useState(false);
  const [showPOCSO, setShowPOCSO] = useState(true);
  ...
  return (
    <div className="chat-page theme-chat">
      ...
      {/* Kavach SOS Button */}
      <KavachSOSButton currentUser={currentUser} activeChat={activeChat} />
      ...
      <div className="chat-body">
        ...
        <div className="chat-main">
          {showPOCSO && strikeCount >= 2 && (
            <POCSOBanner visible={true} onDismiss={() => setShowPOCSO(false)} />
          )}
      ...
      {/* Sakhi Companion Card — appears after first strike */}
      <SakhiCompanionCard
        visible={strikeCount >= 1 || showSakhi}
        onDismiss={() => setShowSakhi(false)}
      />
    </div>
  );
}
